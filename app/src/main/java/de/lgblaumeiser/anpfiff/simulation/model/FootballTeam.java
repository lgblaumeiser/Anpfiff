...
public class FootballTeam {
	 ...
	 */
	public FootballTeam(final String name, final int offensiveStrength, final int defensiveStrength, final int teamShape) {
		checkNotNull(name);
	...
	public boolean equals(Object obj) {
		if (obj instanceof FootballTeam) {
			...
			return equal(name, other.name) && equal(defensiveStrength, other.defensiveStrength)
					&& equal(offensiveStrength, other.offensiveStrength) && equal(teamShape, other.teamShape);
		}
		return false;
	}
